...
def water_plant(intent_request):
...
def get_soil_moisture(intent_request):
    ...
    if moisture=='0':
        message='You need to water your Smart Garden because the humidity is low'
    elif moisture=='1':
...
def get_timelapse(intent_request):
    ...
    message='I\'ll generate your Smart Garden Timelapse and send to your e-mail!'
    return close({ 'key1': 'value1' }, 'Fulfilled', message)
...
def dispatch(intent_request):
    ...
    if intent_name == 'PlantWatering':
        return water_plant(intent_request)
...
def send_timelapse_email():
    ...
    SENDER = "Sender Name <E-MAIL HERE> - YOU SHOULD VALIDATE THE E-MAIL FIRST"
